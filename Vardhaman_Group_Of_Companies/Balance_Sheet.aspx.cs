...
public partial class Balance_Sheet : System.Web.UI.Page
{
    ...
    public int n, o, p, q;
    public double r = 0, r1 = 0, name1 = 0, name2 = 0, name3 = 0, name4 = 0,name5=0,name6=0,name7=0,name8=0;
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        if (Session["project_id"] != null)
        {
            ...
            val78 = Session["project_id"].ToString() + "_account";
            val79 = Session["project_id"].ToString() + "_sales";
            val80 = Session["project_id"].ToString() + "_purchase";
            val81 = Session["project_id"].ToString() + "_customer";
            f = val;
