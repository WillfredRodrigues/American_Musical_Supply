<%@ Page Title="" Language="C#" MasterPageFile="Interface.master" AutoEventWireup="true" CodeFile="View_Customer.aspx.cs" Inherits="View_Customer" %>
...
<div class="side-content fr">
        ...
        <center><font color="#153450" size="4px" style="margin-top:10px"><b><u>View Customer Information</u></b></font></center></div>
            <br />
                    ...
                    <td>
                     ...
                     <td>
                        <center>
                            ...
                            --%>
                            <a href="View_Customer1.aspx?id=<%=dr.GetString(0) %>" class="round blue my_button  text-upper">
                               View</a>
                        </center>
                    </td>
