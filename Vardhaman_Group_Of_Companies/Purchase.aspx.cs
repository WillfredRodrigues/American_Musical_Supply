    ...
    protected void Page_Load(object sender, EventArgs e)
    {
      ...
      .ConnectionStrings["conString"].ConnectionString;
        ...
        if (!IsPostBack)
        {
            ...
            if (status != null)
            {
                Response.Write("<script>alert('Purchase Entry Has Successfully Been Added');</script>");
    ...
    protected void btnSub_Click(object sender, EventArgs e)
    {
      ...
      String strConnString = System.Configuration.ConfigurationManager
            ...
            if (sp != txtvname.Text)
            {
                ...
                Page.ClientScript.RegisterStartupScript(this.GetType(), "alert", "SelectName('Add_Ledger.aspx?id=txtvname&id1=" + val + "&id2=Vendor');", true);
            }

            else if (sp1 != txtpurby.Text)
            {
                Response.Write("<script>alert('Not Valid Purchaser')</script>");
                Page.ClientScript.RegisterStartupScript(this.GetType(), "alert", "SelectName('Add_Ledger.aspx?id=txtpurby&id1=" + val + "&id2=Purchaser');", true);
            }
            else
            {
                int j;
                ...
                else
                {
                    ...
                    string strq2 = "insert into  " + val45 + "  values('" + g + "','" + txtmname.Text + "','" + txtqty.Text + "','" + txtqtype.Text + "')";
                    SqlCommand cmd2 = new SqlCommand(strq2, con);
                    SqlDataAdapter da2 = new SqlDataAdapter(cmd2);
                    DataSet ds2 = new DataSet();
                    da2.Fill(ds2, val45);
