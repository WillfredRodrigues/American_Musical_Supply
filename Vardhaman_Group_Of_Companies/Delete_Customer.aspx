<%@ Page Title="" Language="C#" MasterPageFile="~/Interface.master" AutoEventWireup="true" CodeFile="Delete_Customer.aspx.cs" Inherits="Delete_Customer" %>
                    ...
                    <td>
                     ...
                     <td>
                        <center>
                            ...
                            --%>
                            <a href="Delete_Customer1.aspx?id=<%=dr.GetString(0) %>" class="round blue my_button  text-upper">
                                Delete</a>
                        </center>
                    </td>
