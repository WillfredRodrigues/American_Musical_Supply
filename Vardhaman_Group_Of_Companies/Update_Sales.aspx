<%@ Page Title="" Language="C#" MasterPageFile="Interface.master" AutoEventWireup="true" CodeFile="Update_Sales.aspx.cs" Inherits="Update_Sales" %>
...
<%if (Session["rightupdate"].ToString() == "1") %>
    ...
    <div class="side-content fr">
        ...
        <center><font color="#153450" size="4px" style="margin-top:10px"><b><u>Update Sales Information</u></b></font></center></div>
            <br />
            ...
            runat="server" ErrorMessage="Required" ControlToValidate="txtmob" ForeColor="Red"></asp:RequiredFieldValidator>
                            </td>
                        </tr>
                        <tr>
                            <td>
