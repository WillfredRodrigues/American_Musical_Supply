<%@ Page Title="" Language="C#" MasterPageFile="Interface.master" AutoEventWireup="true" CodeFile="Update_Usage1.aspx.cs" Inherits="Update_Usage1" %>
...
<div class="side-content fr">
        ...
        <center><font color="#153450" size="4px" style="margin-top:10px"><b><u>Update Usage Information</u></b></font></center></div>
           <br />
            ...
            <table style="padding: inherit; border-spacing: inherit; caption-side: inherit; empty-cells: inherit;"
                ...
                <%int i = 1; %>
                <% string s = "select material_name,quantity,quantity_type,used_by,balance_material,balance_material_type,use_date,use_id from " + val + " order by use_date desc"; %>
                ...
                <tr>
                  ...
                  <td>
                        <center>
                            ...
                            --%>
                            <a href="Update_Usage.aspx?id=<%=dr.GetString(7) %>" class="round blue my_button  text-upper">
                                Update</a>
                        </center>
                    </td>
                </tr>
