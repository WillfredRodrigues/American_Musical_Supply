<%@ Page Title="" Language="C#" MasterPageFile="Interface.master" AutoEventWireup="true" CodeFile="Delete_Journal.aspx.cs" Inherits="Delete_Journal" %>
...
<%if (Session["rightdelete"].ToString() == "1") %>
  ...
  <div class="side-content fr">
        ...
        <center><font color="#153450" size="4px" style="margin-top:10px"><b><u>Delete Journal Information</u></b></font></center></div>
           <br />
