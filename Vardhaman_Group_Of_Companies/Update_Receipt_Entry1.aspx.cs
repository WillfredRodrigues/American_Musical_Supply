...
public partial class Update_Receipt_Entry1 : System.Web.UI.Page
{
    ...
    int i1;
    static string val44, val45, val46,gen5;
    ...
    protected void submit_Click(object sender, EventArgs e)
    {
        ...
        else
        {
            ...
            else if (gen1.Value == "Income")
            {
                ...
                {
                    string s78 = "select display from ledger where name='" + gen5 + "'";
                    SqlDataReader dr78;
                    SqlCommand cmd78 = new SqlCommand(s78, con);
                    dr78 = cmd78.ExecuteReader();
                    while (dr78.Read())
            ...
            if (gen2=="Liability")
            {
                ...
                string strq12 = "update " + val + " set date='" + txtdate.Text + "',account='" + txtacc.Text + "',name='" + txtname.Text + "',amount='" + txtamt.Text + "',chk_no='" + txtchkddno.Text + "',chk_date='" + txtchkdddate.Text + "',bank_name='" + txtname.Text + "',credit='',debit='"+txtamt.Text+"',balance='" + ba + "',narration='" + txtnara.InnerText + "',description='" + txtdesc.InnerText + "',type='Receipt' where transaction_id='" + a + "'";
