<%@ Page Title="" Language="C#" MasterPageFile="Interface.master" AutoEventWireup="true" CodeFile="Journal.aspx.cs" Inherits="Journal" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="Scripting" Runat="Server">
    ...
    function SelectName1(url) {
        ...
        window.open(url, 'Popup', 'toolbar=no,location=no,statusbar=no,menubar=no,resizable=0,width=4,height=150,left=490,top=300');
...
<asp:Content ID="Content3" ContentPlaceHolderID="main" Runat="Server">
  ...
  <div class="side-content fr">
        ...
        <center><font color="#153450" size="4px" style="margin-top:10px"><b><u>Add Jounal Information</u></b></font></center></div>
           <br />
            ...
            <tr>
                ...
                <td>
                     Dr Name:(<a href="#" onclick="SelectName('Add_Ledger.aspx?id=txtacc&id1=<%=val %>&id2=Journal'); return false;">Create
                                    New</a>)
                </td>
                <td>
            ...
            runat="server" ErrorMessage="Required" ControlToValidate="txtacc" ForeColor="Red"></asp:RequiredFieldValidator>
                ...
                <tr>
                <td>
                   Cr Name:(<a href="#" onclick="SelectName('Add_Ledger.aspx?id=txtname&id1=<%=val %>&id2=Journal'); return false;">Create
                                    New</a>)
                </td>
                <td>
