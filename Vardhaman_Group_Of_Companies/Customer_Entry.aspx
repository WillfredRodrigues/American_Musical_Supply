<%@ Page Title="" Language="C#" MasterPageFile="Interface.master" AutoEventWireup="true"
    CodeFile="Customer_Entry.aspx.cs" Inherits="Customer_Entry" %>

<%@ Register Assembly="AjaxControlToolkit" Namespace="AjaxControlToolkit" TagPrefix="cc1" %>
<asp:Content ContentPlaceHolderID="Scripting" runat="server">
</asp:Content>
<asp:Content ID="Content1" ContentPlaceHolderID="side" runat="Server">
    ...
    <script type="text/javascript">
        ...
        function SelectName1(url) {
            ...
            window.open(url, 'Popup', 'toolbar=no,location=no,statusbar=no,menubar=no,resizable=0,width=400,height=200,left=490,top=300');
...
<asp:Content ID="Content2" ContentPlaceHolderID="main" runat="Server">
    ...
    <div class="side-content fr">
        ...
        <center><font color="#153450" size="4px" style="margin-top:10px"><b><u>Add Customer Information</u></b></font></center></div>
           <br />
            ...
            runat="server" ErrorMessage="Required" ControlToValidate="txtrate" ForeColor="Red"></asp:RequiredFieldValidator><br />
      ...
      <asp:TextBox AutoComplete="off" CssClass=" round" Width="180px" Height="25px" ID="txtbdate"
        ...
        <cc1:CalendarExtender Format="dd/MM/yyyy" ID="CalendarExtender1" TargetControlID="txtbdate" runat="server">
            ...
            runat="server" ErrorMessage="Required" ControlToValidate="txtbdate" ForeColor="Red"></asp:RequiredFieldValidator>
                            ...
                            <td>
                                Name:(<a href="#" onclick="SelectName('Add_Ledger1.aspx?id=txtname&id1=nid&id2=nname&id3=cname&id4=mainid&id5=mainname'); return false;">Create
                                    New</a>)
                            </td>
                            <td>
                                <asp:TextBox AutoComplete="off" CssClass=" round" Width="180px" Height="25px" ID="txtname"
                                    runat="server" ClientIDMode="Static" Enabled="false"></asp:TextBox><br />
            ...
            runat="server" ErrorMessage="Required" ControlToValidate="txtmob1" ForeColor="Red"></asp:RequiredFieldValidator><br />
            ...
            runat="server" ErrorMessage="Required" ControlToValidate="txtcaddress" ForeColor="Red"></asp:RequiredFieldValidator><br />
                            </td>
                             <td>
                                Permanent address:
                            </td>
                            <td>
                                ...
                                <asp:CheckBox ID="chk1" runat="server" onchange="chk()" />Same As Current
                            </td>
                        </tr>
                        <tr>
