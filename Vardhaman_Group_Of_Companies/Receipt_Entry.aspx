<%@ Page Title="" Language="C#" MasterPageFile="Interface.master" AutoEventWireup="true" CodeFile="Receipt_Entry.aspx.cs" Inherits="Receipt_Entry" %>
...
<%if (Session["rightinsert"].ToString() == "1") %>
  ...
  <div class="side-content fr">
        ...
        <center><font color="#153450" size="4px" style="margin-top:10px"><b><u>Add Receipt Information</u></b></font></center></div>
            <br />
      ...
      <asp:TextBox AutoComplete="off" CssClass=" round"  ID="txtdate"
