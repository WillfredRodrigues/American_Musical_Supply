...
public partial class Update_Task1 : System.Web.UI.Page
{
    ...
    protected void Button1_Click(object sender, EventArgs e)
    {
        ...
        con.Open();
            ...
            string strq = "update " + val + " set name='"+name.Text+"',description='"+desc.InnerText+"',from_d='"+frmdate.Text+"',to_d='"+todate.Text+"',assigned='"+ass.Text+"',status='"+stat.SelectedItem.Value+"'  where id='" + dat.Value + "'";
            SqlCommand cmd11 = new SqlCommand(strq, con);
            SqlDataAdapter da = new SqlDataAdapter(cmd11);
            DataSet ds = new DataSet();
            da.Fill(ds, val);
            Response.Redirect("Task.aspx?id1=success");
