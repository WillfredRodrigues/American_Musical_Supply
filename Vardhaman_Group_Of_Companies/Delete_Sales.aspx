<%@ Page Title="" Language="C#" MasterPageFile="Interface.master" AutoEventWireup="true" CodeFile="Delete_Sales.aspx.cs" Inherits="Delete_Sales" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="main" runat="Server">
   <%if (Session["rightdelete"].ToString() == "1") %>
    ...
    <div class="side-content fr">
        ...
        <center><font color="#153450" size="4px" style="margin-top:10px"><b><u>Delete Sales Information</u></b></font></center></div>
           <br />
