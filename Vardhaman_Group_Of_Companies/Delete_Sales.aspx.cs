...
public partial class Delete_Sales : System.Web.UI.Page
{
    ...
    protected void btnSub_Click(object sender, EventArgs e)
    {
        ...
        da3.Fill(ds3, val);
        string strq10000 = "update  " + val44 + "  set balance=balance-'" + txtamt.Text + "' where name='" + txtvname.Text + "' and type='Buyer'";
        ...
        Response.Redirect("Sales_Home.aspx?success1=true");
    }
}