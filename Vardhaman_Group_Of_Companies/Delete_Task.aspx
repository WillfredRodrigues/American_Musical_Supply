<%@ Page Title="" Language="C#" MasterPageFile="Interface.master" AutoEventWireup="true" CodeFile="Delete_Task.aspx.cs" Inherits="Delete_Task" %>
                ...
                <tr>
                    ...
                    <td>
                        <center>
                            ...
                            --%>
                            <a href="Delete_Task1.aspx?id=<%=dr.GetValue(0) %>" class="round blue my_button  text-upper">
                                Delete</a>
                        </center>
                    </td>
                </tr>
