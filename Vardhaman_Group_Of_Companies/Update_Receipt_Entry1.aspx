<%@ Page Title="" Language="C#" MasterPageFile="Interface.master" AutoEventWireup="true" CodeFile="Update_Receipt_Entry1.aspx.cs" Inherits="Update_Receipt_Entry1" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="side" Runat="Server">
 <div class="side-menu fl"><asp:HiddenField ID="ty" runat="server" /><asp:HiddenField ID="ty1" runat="server" /><asp:HiddenField ID="gen1" runat="server" />
...
<%if (Session["rightinsert"].ToString() == "1") %>
  ...
  <div class="side-content fr">
        ...
        <center><font color="#153450" size="4px" style="margin-top:10px"><b><u>Update Receipt Information</u></b></font></center></div>
            <br />
            ...
            runat="server" ErrorMessage="Required" ControlToValidate="txtacc" ForeColor="Red"></asp:RequiredFieldValidator>
                ...
                <tr>
                <td>
                    Name:(<a href="#" onclick="SelectName('Add_Ledger.aspx?id=txtname&id1=<%=val %>&id2=Receipt'); return false;">Create
                                    New</a>)
                </td>
                <td>
